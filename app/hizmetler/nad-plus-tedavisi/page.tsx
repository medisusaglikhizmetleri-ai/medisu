...
export const metadata: Metadata = {
  title: "NAD+ Uygulaması İstanbul | MEDİSU Evde Sağlık",
  description:
    "İstanbul genelinde hekim değerlendirmesi doğrultusunda evde NAD+ uygulaması hakkında bilgi alın. Profesyonel sağlık personeli ile planlama.",
};

const features = [
  {
    icon: Dna,
    title: "Hücresel Metabolizmada Rol",
    text:
      "NAD+, hücrelerde enerji üretimi ve çeşitli metabolik reaksiyonlarda görev alan doğal bir koenzimdir.",
  },
  {
    icon: Stethoscope,
    title: "Hekim Değerlendirmesi",
    text:
      "Uygulamanın gerekliliği ve kişiye uygunluğu sağlık durumu değerlendirilerek belirlenmelidir.",
  },
  {
    icon: ShieldCheck,
    title: "Steril Uygulama",
    text:
      "Damar yolu uygulamalarında steril ürün, uygun hazırlama koşulları ve profesyonel sağlık personeli önemlidir.",
  },
  {
    icon: House,
    title: "Evde Uygulama",
...
const process = [
  ...
  "Kişinin sağlık durumu, mevcut hastalıkları ve kullandığı ilaçlar hakkında bilgi alınır.",
  "NAD+ uygulamasının uygunluğu hekim değerlendirmesi doğrultusunda belirlenir.",
  "Uygun planlama sonrasında sağlık personeli belirlenen saatte adrese yönlendirilir.",
  "Uygulama steril koşullarda gerçekleştirilir ve infüzyon süreci takip edilir.",
];
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 py-12 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                NAD+ (nikotinamid adenin dinükleotid), hücresel enerji
                metabolizmasında görev alan doğal bir koenzimdir. Damar
                yoluyla uygulanmasının gerekliliği ve kişiye uygunluğu
                hekim değerlendirmesine göre belirlenmelidir.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-white bg-white p-2 shadow-[0_25px_70px_rgba(15,23,42,.15)] sm:p-3">
                <Image
                  src="/images/services/nad-plus.png"
                  alt="NAD+ uygulaması"
                  width={900}
                  height={900}
                  priority
        ...
        <section className="py-14 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-4xl px-5 sm:px-6">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-slate-600 sm:text-lg">
              <p>
                NAD+, vücutta doğal olarak bulunan ve enerji metabolizması,
                redoks reaksiyonları ve çeşitli hücresel süreçlerde rol alan
                bir koenzimdir.
              </p>

              <p>
                NAD+ biyolojisi iyi tanımlanmış olsa da damar yoluyla NAD+
                uygulamalarının enerji, yaşlanma, zihinsel performans veya
                genel wellness amaçlarıyla kullanımına ilişkin klinik
                etkinlik kanıtları henüz sınırlıdır.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-14 sm:py-16 lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-6 lg:grid-cols-[1fr_.8fr] lg:gap-16">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-slate-900 sm:text-4xl">
                Evde NAD+ Uygulaması Nasıl Planlanır?
              </h2>
            ...
            <div className="self-start rounded-[28px] bg-gradient-to-br from-sky-950 via-sky-900 to-cyan-700 p-7 text-white shadow-xl sm:p-8">
              ...
              <h3 className="mt-5 text-2xl font-extrabold">
                İnfüzyon Sırasında Takip Önemlidir
              </h3>

              <p className="mt-4 leading-7 text-sky-100">
                NAD+ infüzyonlarında tolerabilite kişiden kişiye değişebilir.
                Uygulama sırasında oluşabilecek şikâyetler nedeniyle sağlık
                personeli takibi önemlidir.
              </p>
          ...
          <div className="mx-auto max-w-5xl px-5 sm:px-6">
            <div className="rounded-[24px] border border-amber-200 bg-white p-6 sm:p-8">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
                NAD+ uygulamasının birçok wellness amacı için klinik
                etkinliği kesinleşmiş değildir. Bu sayfadaki bilgiler genel
                bilgilendirme amacı taşır. Uygulamanın gerekliliği, dozu ve
                süresi hekim değerlendirmesine göre belirlenmelidir.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl px-5 sm:px-6">
            <div className="rounded-[30px] bg-gradient-to-r from-sky-950 via-sky-900 to-cyan-700 p-7 text-center text-white shadow-2xl sm:p-10">
              ...
              <h2 className="mt-4 text-3xl font-extrabold">
                NAD+ Uygulaması Hakkında Bilgi Alın
              </h2>
